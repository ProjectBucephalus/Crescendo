...
public class aimToAmpSequence extends ParallelCommandGroup {
    ...
    public aimToAmpSequence(Swerve s_Swerve, Shooter s_Shooter, Pivot s_Pivot, RumbleController s_RumbleController, DoubleSupplier translationSup, DoubleSupplier strafeSup, DoubleSupplier brakeSup) {
